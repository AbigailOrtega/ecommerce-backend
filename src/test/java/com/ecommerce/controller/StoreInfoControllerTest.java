...
class StoreInfoControllerTest {
    ...
    private StoreInfoResponse stubResponse(boolean withImages) {
        List<StoreImage> images = withImages
                ...
                : List.of();
        return new StoreInfoResponse("Mi Tienda", "Descripción", "Misión", "Visión", "+52 55 1234", null, null, images);
    }
    ...
    class Update {
        ...
        void update_200() throws Exception {
            StoreInfoRequest req = new StoreInfoRequest("Nuevo", "Nueva desc", null, null, null, null, null);
